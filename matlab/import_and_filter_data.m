function [vic_t, vic_pose_w, vic_pose_b, vic_ypr_w, d_vic_t, vic_pose_smoothed_b, vic_vel_smoothed_b, vic_acc_smoothed_b, att_t, beb_rpy_b, speed_t, beb_vel_enu, speed_t_sync, beb_vel_b, cmdvel_t, cvel_p_r_vz_vyaw_b, beb_vel_enu_ts, beb_rpy_b_ts] = import_and_filter_data(csvfilebase, sgolay_order, sgolay_win_size)
% variable naming
% <source>_<info>_<frame>
% vic: vicon, beb: bebop
% w: room coordinates, b: bebop coords
...
cmdvel_data_file = strcat(csvfilebase, '_cmdvel.csv');
...
speed_data = importdata('2016-01-18-11-56-51_speed.csv', ',', 1);
r = size(speed_data.textdata);
speed_t = str2double(speed_data.textdata(2:r,3)) * 1e-9;
speed_t = speed_t - speed_t(1,1);
